...
public class CompanyServiceImpl implements CompanyService {
  ...
  @Autowired
  public CompanyServiceImpl(CompanyRepository companyRepository, UserRepository userRepository, ModelMapper modelMapper, AmazonS3ImageService amazonS3ImageService) {
  ...
  @Override
  public CompanyDTO updateLogo(MultipartFile multipartFile, UUID companyId, UUID userId) {
    User user = this.getUser(userId);
