...
class CompanyControllerTests {
  ...
  @Autowired
  CompanyControllerTests(MockMvc mockMvc) {
    this.mockMvc = mockMvc;
    this.mapper = new ObjectMapper();
  }

  @Test
  void itShouldBeReturnedStatusCreatedForANewCompany() throws Exception {
  ...
  @Test
  void itShouldBeReturnedBadRequestWhenNoPassNameOfCompany() throws Exception {
    this.mockMvc.perform(post("/companies")
      .accept(MediaType.APPLICATION_JSON_VALUE)
      .contentType(MediaType.APPLICATION_JSON_VALUE))
